...
import ProductSection from '../pages/ProductDetail/ProductSection';
...
describe('CONTEXT', () => {
  describe('cart functions', () => {
    it('add items into the cart', () => {
      ...
      const cartLength = getByTestId('cart-length');
      const addToCartButton = getByTestId('add-to-cart');

      fireEvent.click(addToCartButton);
      expect(cartLength.textContent).toBe('Cart (1)');
    });
  });
});
